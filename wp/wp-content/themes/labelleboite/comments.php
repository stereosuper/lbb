			...
			<form action='<?php echo get_option('siteurl'); ?>/wp-comments-post.php' method='post' class='commentform'>
				...
				<?php if( !$user_ID ) : ?>
					...
					<fieldset>
						<label for='author' class='required'>
							Votre nom
						</label><input type='text' name='author' id='author' value='<?php echo $comment_author; ?>' required>
						<span></span>
					</fieldset>
					<fieldset>
						<label for='email' class='required'>
							Votre email
						</label><input type='email' name='email' id='email' value='<?php echo $comment_author_email; ?>' required>
						<span></span>
					</fieldset>
					<fieldset>
						<label for='url'>
							Votre site
						</label><input type='url' name='url' id='url' value='<?php echo $comment_author_url; ?>'>
						<span></span>
					</fieldset>					
				...
				<fieldset>
					<label for='comment' class='required'>
						Votre commentaire
					</label><textarea name='comment' id='comment' required></textarea>
					<span></span>
				</fieldset>
